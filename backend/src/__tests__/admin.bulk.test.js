  ...
  it('should delete multiple events and call deleteFromCloudinary for events with posterUrl', async () => {
    ...
    mockEvent.findByIdAndDelete
      .mockResolvedValueOnce({
        _id: VALID_ID_1,
        posterUrl: 'https://res.cloudinary.com/demo/image/upload/v123/evento/posters/poster1.webp',
      })
      .mockResolvedValueOnce({
        _id: VALID_ID_2,
        posterUrl: null,
    ...
    expect(mockDeleteFromCloudinary).toHaveBeenCalledWith(
      'https://res.cloudinary.com/demo/image/upload/v123/evento/posters/poster1.webp'
    );
  });
