...
const features = [
  ...
  },
  {
    ...
    content:
      "Trusted by communities for organizing and managing successful events",
    icon: <Code className="text-primary h-6 w-6" />,
    image:
      "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2070&auto=format&fit=crop",
  },
      ...
      <div className="mx-auto w-full max-w-7xl">
        <div className="relative mx-auto mb-12 max-w-2xl sm:text-center">
          <div className="relative z-10">
            ...
            <p className="text-muted-foreground mx-auto mt-4 max-w-2xl text-lg sm:text-xl leading-relaxed">
              Evento helps you create, customize, and deploy your Events
