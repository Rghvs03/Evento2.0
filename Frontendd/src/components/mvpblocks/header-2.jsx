        ...
        >
          <div className="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
                    ...
                    >
                      ...
                      {isActive && (
                        <motion.span
                          ...
                          className="absolute bottom-0.5 left-1/2 h-1 w-1 -translate-x-1/2 rounded-full bg-rose-500"
                          transition={{
                            type: "spring",
                            stiffness: 400,
                            damping: 30,
            ...
            >
              ...
              <motion.button
                className="text-rose-500 hover:bg-rose-500/10 rounded-lg p-2 transition-colors duration-200"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
              ...
              {user ? (
                <div className="flex items-center space-x-3">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                  >
                    <div className="h-8 w-8 rounded-full bg-rose-100 flex items-center justify-center border border-rose-200 overflow-hidden">
                      {user.avatarUrl ? (
                        <img
                          src={user.avatarUrl}
                          alt="Profile"
                      ...
                      <motion.div key={item.name} variants={mobileItemVariants}>
                        <Link
                          ...
                          className={`block rounded-xl px-4 py-3 font-medium transition-all duration-200 active:scale-[0.98] ${
                            isActive
                              ? "bg-rose-500/15 text-foreground ring-1 ring-rose-500/25"
