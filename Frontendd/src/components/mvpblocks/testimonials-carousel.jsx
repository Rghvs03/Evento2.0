...
const defaultTestimonials = [
  {
    text: "Evento revolutionized how we organize our tech conferences. The ticketing and scheduling features are flawless.",
    imageSrc:
  ...
  {
    text: "Finally an event platform that doesn't feel clunky. Evento is sleek, fast, and our attendees loved the check-in process.",
    imageSrc:
  ...
  {
    text: "We managed 500+ attendees with zero hiccups. Evento's dashboard gave us real-time insights that saved the day.",
    imageSrc:
  ...
  {
    text: "Setting up our annual summit took minutes instead of days. Evento handles everything from registration to post-event feedback.",
    imageSrc:
  ...
  {
    text: "The best investment for our community meetups. Evento makes it incredibly easy to manage RSVPs and communicate with members.",
    imageSrc:
  ...
  {
    text: "Design is important to us, and Evento looks beautiful out of the box. It matches our brand perfectly.",
    imageSrc:
...
export default function TestimonialsCarousel({
  ...
  subtitle = "From intimate meetups to global conferences, Evento powers the world's most successful events.",
  className,
}) {
