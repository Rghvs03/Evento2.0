...
First off, thank you for considering contributing to **evento**! It's people like you that make evento such a great tool. 

## Project Overview

**evento** is a full-stack event management system built with:
...
3. **Add the original repository as upstream**:
   ```bash
   git remote add upstream https://github.com/OriginalOwner/evento.git
   ```
